  ...
  private static final String IMAGE_URL_BASE = "http://oceanbook.ignistudios.com/";
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (jsonObject.has("mainimage")) {
            ...
            String imageID = jsonObject.optString("mainimage");
        ...
        if (jsonObject.has("commonname")) {
            bookTitle = jsonObject.optString("commonname");
        }

        if (jsonObject.has("scientificname")) {
            authorName = jsonObject.optString("scientificname");
        }
